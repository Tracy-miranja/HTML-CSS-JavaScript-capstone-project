...
**MIRANJA TRACY HTML/CSS & JavaScript capstone project** is a webpage with to section home page and about page That i have created for a web development course
...
```sh
  cd my-folder
  git clone git@github.com:Tracy-miranja/HTML-CSS-JavaScript-capstone-project.git
```
...
I would like to thank to all my Mricronauts partners for support and microverse for giving me this design template to work on.
i would also like to thank Cindy Shin in Behance for the ui/ux design in behance.
